...
do
    ...
    if [ ! -f /home/container/dodatkowe-lobby/config.yml ]; then
        ...
        sed -e "s/query_port: \([0-9]\+\)/query_port: ${INTERNAL_LOBBY_PORT}/g" -e "s/host: 0.0.0.0:\([0-9]\+\)/host: 0.0.0.0:${INTERNAL_LOBBY_PORT}/g" /home/container/dodatkowe-lobby/config.yml > /home/container/dodatkowe-lobby/bh_config.yml
        mv /home/container/dodatkowe-lobby/bh_config.yml /home/container/dodatkowe-lobby/config.yml
    fi
